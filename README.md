...
## Upcoming Script Plan :
1. Screen Clicker Using Images.
2. Movement Motion (W, A, S, D or Up, Left, Right, Down arrow) Using Mouse Movement.
3. Move Mouse Using Motion Input (W, A, S, D or Up, Left, Right, Down arrow).
